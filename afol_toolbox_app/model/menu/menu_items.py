...
class Tool(MenuItem):
    ...
    def __init__(self, definition: dict, parent):
        ...
        if KEY_VIEW_FUNC in definition:
            ...
            self._view_func = Tool._default_view_func

    @staticmethod
    def _default_view_func(*args, **kwargs):
        raise ValueError(f"View function not defined!")
...
def print_menudefinition_tree(tree: List[MenuItem]):
    """
...
if __name__ == '__main__':
    print_menudefinition_tree(get_menu())
